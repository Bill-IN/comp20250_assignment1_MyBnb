...
public class BnbApartment extends BnbProperty
{
	 ...
	 */
	public BnbApartment(int storeyNum, int numBeds, String AnOwnersName, String aPostalAddress, int initialRentalCostPerDay, int intitialTotalNumberOfSeasonsRentalDays)//One number or an amount??
	{
