...
public class BnbProperty 
{
	 ...
	 * @param intitialTotalNumberOfSeasonsRentalDays:
	 * 
	 */
	
	public BnbProperty(String AnOwnersName, String aPostalAddress, int initialRentalCostPerDay, int intitialTotalNumberOfSeasonsRentalDays)
	{
		...
		this.totalNumberOfSeasonsRentalDays = intitialTotalNumberOfSeasonsRentalDays;
	}
	...
	/**
	 * This method increases the total number of rental days.
	 * @param RentalDays number of additional days
	 */
	protected void RentProperty(int RentalDays)
	{
