...
public class BnbHouse extends BnbProperty
{
	 ...
	 */
	//Constructor
	public BnbHouse(int totalNumStoreys, int clearing_Fees, String AnOwnersName, String aPostalAddress, int initialRentalCostPerDay, int intitialTotalNumberOfSeasonsRentalDays)
	{
